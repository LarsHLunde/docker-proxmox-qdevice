...
print("ssh-keyscan -p " ..  qdevport .. " " .. qdevip .. " >> ~/.ssh/known_hosts")
print("")
...
if yes_or_no() then
	execute_return("ssh root@" .. node1ip .. " \"ssh-keyscan -p " ..  qdevport .. " " .. qdevip .. " >> ~/.ssh/known_hosts\"")
end
...
if yes_or_no() then
	execute_return("ssh root@" .. node2ip .. " \"ssh-keyscan -p " ..  qdevport .. " " .. qdevip .. " >> ~/.ssh/known_hosts\"")
end
